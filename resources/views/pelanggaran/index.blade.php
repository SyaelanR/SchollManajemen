...
<head>
    ...
    <title>Pilih Kelas Pelanggaran - EduSys</title>
    <!-- Tailwind CSS CDN -->
    ...
    <div class="flex-1 flex flex-col overflow-y-auto">
        ...
        <main class="p-6 md:p-8 flex-1">
            <header class="mb-8 bg-indigo-600 p-8 rounded-2xl shadow-lg text-white">
                <h2 class="text-3xl font-bold mb-2">Pilih Kelas</h2>
                <p class="text-indigo-200">Pilih kelas untuk melihat atau menambahkan data pelanggaran siswa.</p>
            </header>

            <div class="bg-white rounded-xl shadow-md p-6">
                 <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                    <h2 class="text-2xl font-semibold text-gray-800">Daftar Kelas Tersedia</h2>
                    <div class="relative w-full md:w-1/3">
                        <input type="text" id="class-search-input" placeholder="Cari nama kelas..." class="w-full pl-10 pr-4 py-2 border rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        <i class="fa-solid fa-search text-gray-400 absolute left-4 top-1/2 transform -translate-y-1/2"></i>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    <!-- Class Cards will be dynamically inserted here -->
                     @forelse ($kelasList ?? [] as $kelas)
                        <a href="{{route('pelanggaran.daftar', $kelas->id_kelas)}}" class="block bg-white border rounded-xl shadow-md p-6 hover:shadow-lg hover:-translate-y-1 transform transition-all duration-300">
