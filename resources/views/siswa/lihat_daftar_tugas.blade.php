...
<head>
    ...
    <title>Tugas Fisika - Sistem Manajemen Sekolah</title>
    <!-- Tailwind CSS CDN -->
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-y-auto">
            ...
            <header class="bg-white shadow-md p-4 flex justify-between items-center sticky top-0 z-30">
                ...
                <h1 class="text-xl md:text-2xl font-semibold text-gray-800">Tugas Fisika</h1>
        ...
        @if ($tugas->nilai == 0 && $tugas->nama_fileTugas == null)
            <div class="bg-white rounded-xl shadow-md p-6 flex flex-col ring-2 ring-indigo-500">
                <div class="flex-1">
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-2">{{ $tugas->judul ?? 'Tugas Tanpa Judul' }}</h3>
                    <p class="text-sm text-gray-600 mb-4 flex items-center">
                        <i class="fa-solid fa-calendar-alt w-4 mr-2 text-gray-400"></i>{{ $tugas->tanggal }}
                    </p>
                </div>
                <div class="border-t pt-4 flex items-center justify-between gap-4">
                    ...
                    <button class="w-1/2 bg-indigo-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 flex items-center justify-center">
