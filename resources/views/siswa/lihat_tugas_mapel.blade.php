    ...
    <div class="flex-1 flex flex-col overflow-y-auto">
        ...
        <main class="p-6 md:p-8 flex-1">
            <header class="mb-8 bg-indigo-600 p-8 rounded-2xl shadow-lg text-white">
                <h2 class="text-3xl font-bold mb-2">Tugas Pelajaran</h2>
                <p class="text-indigo-200">Pilih mata pelajaran untuk melihat tugas yang telah diunggah oleh guru.</p>
            </header>
            ...
            <div id="mapel-list" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <a href="{{ route('lihatTugasDaftar', $mapel->mapel->id_mapel)}}" class="mapel-item block">
