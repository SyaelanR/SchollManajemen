            ...
            <main class="p-6 md:p-8 flex-1">
                ...
                <div class="bg-white rounded-xl shadow-md p-6">
                    ...
                    <div class="flex flex-col md:flex-row items-center gap-4 mb-6">
                        <input type="text" id="class-search-input" placeholder="Cari nama kelas..." class="w-full md:flex-1 p-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    <div id="class-grid" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        <!-- 
                            Elemen-elemen ini akan di-loop menggunakan Blade.
                            Contoh di bawah menunjukkan struktur yang akan diulang.
                        -->
                    ...
                    </div><div class="bg-gray-50 rounded-xl shadow-md p-6 relative hover:shadow-lg transition duration-300 cursor-pointer">
                            <div class="flex items-center mb-4">
                                <i class="fa-solid fa-chalkboard text-3xl text-indigo-500"></i>
                            </div>
