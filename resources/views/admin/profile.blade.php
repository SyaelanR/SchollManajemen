        ...
        <main class="p-6 md:p-8 flex-1">
            ...
            <header class="mb-8 bg-indigo-600 p-6 rounded-2xl shadow-xl text-white flex flex-col md:flex-row justify-between items-start gap-4">
                <div>
                    ...
                    <p class="text-indigo-200 mt-1">NIK/NIP: {{ $user->nik ?? 'Belum diatur' }}</p>
                </div>
            ...
            <div class="space-y-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-1 space-y-8 flex flex-col">
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-lg">
                            <div class="flex flex-col items-center">
                                {{-- Changed placeholder text A for Admin --}}
                                <img class="h-24 w-24 rounded-full object-cover mb-4 border-4 border-indigo-200" src="https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&background=667eea&color=fff&size=128&bold=true&format=svg&rounded=true&placeholder=A" alt="Foto Admin">
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-lg">
                            ...
                            <div class="space-y-3">
                                {{-- Assuming admin has a different security route name, adjust if needed --}}
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        <!-- Detailed Info Card (Read-only) - UPDATED FIELDS -->
                        <div class="bg-white p-6 rounded-xl shadow-lg">
                            <h3 class="text-lg font-semibold text-gray-800 border-b pb-3 mb-4">Data Pribadi Admin</h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 text-sm">
                                <div>
                                    <label class="block text-gray-500">NIK/NIP</label>
                                    {{-- Assuming the user model has 'nik' --}}
                                    <p class="font-medium text-gray-800">{{ $user->nik ?? '-' }}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    <label class="block text-gray-500">Email</label>
                                     {{-- Assuming the user model has 'email' --}}
                                ...
                                {{-- Removed tempat_lahir and tanggal_lahir as per request --}}
                            </div>
