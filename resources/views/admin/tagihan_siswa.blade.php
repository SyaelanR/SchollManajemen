...
<head>
    ...
    <title>Manajemen Tagihan - Sistem Manajemen Sekolah</title>
    <!-- Tailwind CSS CDN -->
...
<body class="bg-gray-100">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-y-auto">
            ...
            <header class="bg-white shadow-md p-4 flex justify-between items-center sticky top-0 z-30">
                ...
                <h1 class="text-xl md:text-2xl font-semibold text-gray-800">Manajemen Tagihan</h1>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full min-w-[800px] text-left">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="p-3 font-semibold text-gray-600">Jumlah Tagihan</th>
                                    <th class="p-3 font-semibold text-gray-600">Tenggat Pembayaran</th>
                                    <th class="p-3 font-semibold text-gray-600">Keterangan</th>
                                    <th class="p-3 font-semibold text-gray-600">Target Angkatan</th>
                                    <th class="p-3 font-semibold text-gray-600">Persentase</th>
    ...
    <!-- Add Bill Modal -->
    <div id="bill-modal" class="modal fixed inset-0 bg-gray-900 bg-opacity-50 z-50 flex items-center justify-center hidden opacity-0">
        <div class="bg-white rounded-xl shadow-2xl p-8 w-11/12 md:w-1/2 lg:w-1/3 transform transition-transform duration-300 scale-95">
            ...
            <form action="{{ route('storeTagihan') }}" method="POST">
                ...
                <div class="flex justify-end gap-4">
                    ...
                    <button type="submit" class="bg-indigo-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-indigo-700 transition duration-300">Simpan Tagihan</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        const modalContent = billModal.querySelector('div');
        ...
        const openModal = () => {
            ...
            setTimeout(() => {
                billModal.classList.remove('opacity-0');
                modalContent.classList.remove('scale-95');
            }, 10);
        };

        const closeModal = () => {
            billModal.classList.add('opacity-0');
