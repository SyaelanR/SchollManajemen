                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <button onclick="showModal('edit')" class="text-indigo-600 hover:text-indigo-900 mx-1">
                                            <i class="fa-solid fa-edit"></i>
                                        </button>
                                        <button onclick="showModal('delete')" class="text-red-600 hover:text-red-900 mx-1">
