    ...
    <aside class="w-64 bg-gray-900 text-gray-100 p-6 flex flex-col items-center">
        ...
        <nav class="w-full">
            <ul>
                ...
                <li class="mb-2">
                    <a href="/wali/profil" class="flex items-center p-3 rounded-lg hover:bg-gray-800 transition-colors duration-200">
    ...
    <main class="flex-1 p-8 overflow-y-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <div class="bg-white p-6 rounded-xl shadow-md flex items-center justify-between">
                <div>
                    <div class="text-sm font-semibold text-gray-500">Total Tagihan</div>
                    <div class="text-3xl font-bold text-gray-900 mt-1">Rp 5.000.000</div>
                </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-md flex items-center justify-between">
                <div>
                    <div class="text-sm font-semibold text-gray-500">Tagihan Belum Lunas</div>
                    <div class="text-3xl font-bold text-gray-900 mt-1">Rp 2.500.000</div>
                </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-md flex items-center justify-between">
                <div>
                    <div class="text-sm font-semibold text-gray-500">Pembayaran Terakhir</div>
                    <div class="text-3xl font-bold text-gray-900 mt-1">Rp 1.000.000</div>
                </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-md">
            <h2 class="text-2xl font-bold text-gray-800 mb-4">Riwayat Pembayaran</h2>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">20 Sep 2025</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">SPP September</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">Rp 1.000.000</td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Lunas</span>
                            </td>
                        </tr>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">10 Ags 2025</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">SPP Agustus</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">Rp 1.000.000</td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Lunas</span>
                            </td>
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">5 Jul 2025</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">SPP Juli</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">Rp 1.000.000</td>
                            <td class="px-6 py-4 whitespace-nowrap">
