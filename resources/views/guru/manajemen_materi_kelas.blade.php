    ...
    <div class="flex h-screen overflow-hidden bg-gray-50">
        ...
        <div class="flex-1 flex flex-col overflow-y-auto">
            ...
            <header class="bg-white shadow-sm p-4 flex justify-between items-center sticky top-0 z-30">
                ...
                <h1 id="header-title" class="text-xl md:text-2xl font-bold text-gray-800">Pilih Kelas untuk Input Materi</h1>
            ...
            <main class="p-6 md:p-8 flex-1">
                <div class="bg-white rounded-2xl shadow-lg p-8 mb-6 text-gray-800 flex flex-col md:flex-row items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600">Silakan pilih kelas untuk melanjutkan proses input Materi.</p>
                    </div>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {{-- Ganti dengan loop @forelse dari Laravel --}}
                    @forelse ($daftarkelasYangDiampu ?? [] as $kelas)
                        <a href="{{ route('inputMateri', [$kelas->id_kelas, $kelas->mapel->id_mapel]) }}" class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300 cursor-pointer">
