        ...
        <main class="p-6 md:p-8 flex-1">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse ($daftarkelasYangDiampu ?? [] as $kelas)
                    <a href="{{ route('manajemenNilaiDaftar', [$kelas->id_kelas, $kelas->mapel->id_mapel]) }}" class="block bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-1 transform transition-all duration-300 cursor-pointer">
