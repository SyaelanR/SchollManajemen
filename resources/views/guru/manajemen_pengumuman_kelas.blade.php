    ...
    <div class="flex-1 flex flex-col overflow-y-auto">
        ...
        <main class="p-6 md:p-8 flex-1">
            ...
            <header class="mb-8 bg-indigo-600 p-8 rounded-2xl shadow-lg text-white">
                ...
                <p class="text-indigo-200">Silakan pilih kelas untuk melanjutkan proses input Pengumuman.</p>
            </header>
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <div id="class-grid" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <a href="{{ route('manajPengumumanDaftar', [$kelas->id_kelas, $kelas->mapel->id_mapel]) }}" class="class-card block bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-1 transform transition-all duration-300 cursor-pointer border">
