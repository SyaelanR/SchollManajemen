        ...
        <main class="p-6 md:p-8 flex-1">
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <div id="class-grid" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <a href="{{ route('manajAbsensiDaftar', [$kelas->id_kelas, $kelas->mapel->id_mapel]) }}" class="class-card block bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-1 transform transition-all duration-300 cursor-pointer border">
